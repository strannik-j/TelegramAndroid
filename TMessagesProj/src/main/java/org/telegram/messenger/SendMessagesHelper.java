...
//            object.checkLayout();
    ...
    public void processForwardFromMyName(MessageObject messageObject, long did, String overwriteText) {
        ...
        if (messageObject.messageOwner.media != null && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaEmpty) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGame) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaInvoice)) {
            ...
            if (messageObject.messageOwner.media.photo instanceof TLRPC.TL_photo) {
                sendMessage(SendMessagesHelper.SendMessageParams.of((TLRPC.TL_photo) messageObject.messageOwner.media.photo, null, did, emptyReplyMessageObject, null, messageOwnerMessage, messageOwnerEntities, null, params, true, 0, messageObject.messageOwner.media.ttl_seconds, messageObject, false));
            } else if (messageObject.messageOwner.media.document instanceof TLRPC.TL_document) {
                sendMessage(SendMessagesHelper.SendMessageParams.of((TLRPC.TL_document) messageObject.messageOwner.media.document, null, messageObject.messageOwner.attachPath, did, emptyReplyMessageObject, null, messageOwnerMessage, messageOwnerEntities, null, params, true, 0, messageObject.messageOwner.media.ttl_seconds, messageObject, null, false));
    ...
    public void sendGifWithCaption(TLRPC.Document document, String query, long peer, MessageObject replyToMsg, MessageObject replyToTopMsg, Object parentObject, MessageObject.SendAnimationData sendAnimationData, boolean notify, int scheduleDate, boolean updateStickersOrder, String caption) {
        ...
        sendSticker(document, query, peer, replyToMsg, replyToTopMsg, null, sendAnimationData, notify, scheduleDate, updateStickersOrder, parentObject, caption);
    }
    ...
    public void sendSticker(TLRPC.Document document, String query, long peer, MessageObject replyToMsg, MessageObject replyToTopMsg, TLRPC.StoryItem storyItem, MessageObject.SendAnimationData sendAnimationData, boolean notify, int scheduleDate, boolean updateStickersOrder, Object parentObject) {
        sendSticker(document, query, peer, replyToMsg, replyToTopMsg, storyItem, sendAnimationData, notify, scheduleDate, updateStickersOrder, parentObject, null);
    }

    public void sendSticker(TLRPC.Document document, String query, long peer, MessageObject replyToMsg, MessageObject replyToTopMsg, TLRPC.StoryItem storyItem, MessageObject.SendAnimationData sendAnimationData, boolean notify, int scheduleDate, boolean updateStickersOrder, Object parentObject, String caption) {
        if (document == null) {
            return;
        }
